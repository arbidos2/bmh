...
(cl:defclass <MotorState> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   :initform (cl:make-array 4 :element-type 'cl:string :initial-element ""))
   (position
    :reader position
    :initarg :position
...
(cl:defmethod cl:initialize-instance :after ((m <MotorState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scout_mini_msgs-msg:<MotorState> is deprecated: use scout_mini_msgs-msg:MotorState instead.")))
...
(cl:defmethod name-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_mini_msgs-msg:name-val is deprecated.  Use scout_mini_msgs-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_mini_msgs-msg:position-val is deprecated.  Use scout_mini_msgs-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_mini_msgs-msg:velocity-val is deprecated.  Use scout_mini_msgs-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_mini_msgs-msg:current-val is deprecated.  Use scout_mini_msgs-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_mini_msgs-msg:temperature-val is deprecated.  Use scout_mini_msgs-msg:temperature instead.")
  (temperature m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotorState>) istream)
  ...
  (cl:setf (cl:slot-value msg 'name) (cl:make-array 4))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorState>)))
  ...
  (cl:format cl:nil "Header header~%~%# Joint name~%string[4] name~%~%# The actual position by the encoder value (rad)~%float64[4] position~%~%# The actual velocity measured by the encoder as the actual RPM value (rad/s)~%float64[4] velocity~%~%# The current flowing through the motor (A)~%float64[4] current~%~%# The actual temperature of motor (C)~%int16[4] temperature   ~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorState)))
  "Returns full string definition for message of type 'MotorState"
  (cl:format cl:nil "Header header~%~%# Joint name~%string[4] name~%~%# The actual position by the encoder value (rad)~%float64[4] position~%~%# The actual velocity measured by the encoder as the actual RPM value (rad/s)~%float64[4] velocity~%~%# The current flowing through the motor (A)~%float64[4] current~%~%# The actual temperature of motor (C)~%int16[4] temperature   ~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MotorState>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'temperature) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 2)))
))
